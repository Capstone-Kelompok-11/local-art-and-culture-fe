      ...
      >
        <div className="col-span-4 sm:col-span-2 md:col-span-1 bg-white p-4 rounded-md relative">
          ...
          <div className="flex flex-col justify-between p-2">
            ...
            <div className='mt-14'>
              <span className="text-[#999999] text-sm mt-10">Pengunjung Hadir (org)</span><br />
              <span className="text-lg font-bold text-sm font-plus-jakarta-sans">87/350</span><br />
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div className="col-span-4 sm:col-span-2 md:col-span-1 bg-white p-4 rounded-md relative">
          ...
          <div className="flex flex-col justify-between p-2">
            ...
            <div className='mt-14'>
              <span className="text-[#999999] text-sm mt-10">Tiket Terjual(pcs)</span><br />
        ...
        >
          <div className="col-span-4 sm:col-span-2 md:col-span-1 bg-white p-4 rounded-md relative">
            ...
            <div className="flex flex-col justify-between p-2">
              ...
              <div className='mt-14'>
                <span className="text-[#999999] text-sm mt-10">Merch Terjual (psc)</span><br />
                <span className="text-lg font-bold text-sm font-plus-jakarta-sans">35.440.000</span><br />
              </div>
            </div>
          </div>
