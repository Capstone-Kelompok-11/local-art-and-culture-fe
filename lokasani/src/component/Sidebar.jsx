...
function Sidebar() {
    ...
    return (
    <>
        <button onClick={openSidebar} type="button" className="inline-flex items-center p-2 mt-2 ml-5 text-sm text-white rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 hover:bg-gray-700 focus:ring-gray-600">
        ...
        <aside 
            ...
            <div className="h-screen px-3 py-4 overflow-y-auto bg-[#253E8D]">
                <h2 href="https://flowbite.com/" className="flex items-center pl-2.5 mb-9 mt-6">
                    ...
                    <span className="custom-font font-medium pt-2 text-white">CREATOR.</span>
                    <svg
                ...
                <div className='mx-2 mb-10'>
                    <a className='cursor-pointer flex items-center justify-center py-3 p-2 text-gray-900 rounded-full text-white bg-[#768DD5]'>+ Add New Event</a>
                </div>
                    ...
                    <div className='mx-3'>
                        <ul className="space-y-3">
                            ...
                            <li>
                                <a
                                className="cursor-pointer text-sm  flex items-center px-2 py-1 rounded-sm text-white hover:bg-gray-700 group">
                                <img src={TransactionIcon} alt="Transaction" className='w-5 h-5'/>
                            ...
                            <li>
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Pusat Bantuan</span>
                                </a>
                            </li>
                            <li>
                                <a
                                ...
                                <span className="flex-1 ml-3 whitespace-nowrap">Ulasan</span>
                                </a>
                            </li>
                        </ul>
                    </div>
