...
//         <div className=" h-screen flex-row my-24 items-center inline-flex relative gap-10">
//           <div className="card-testimoni h-3/6  flex flex-col justify-center bg-white rounded-tr-[80px] rounded-br-[80px]">
//             <div className="text-group mx-24 xl: lg: md: sm: ">
//               <p className="text-4xl uppercase font-bold my-4">testimoni</p>
//               <p className="text-regular capitalize w-2/3">
//                 dengarkan pengalaman mereka temukan inspirasi anda
//               </p>
//             </div>
//             <div className="assets">
//               <span className="h-[50px] rounded-full bg-blue-900"></span>
//               <span className="h-[50px] rounded-full bg-blue-900"></span>
//             </div>
//           </div>
//           <div className="flex-row justify-center items-center inline-flex gap-7 ">
//             {/* col 1*/}
//             <div className="flex-col space-y-10  ">
//               {/* new card */}
//               <div className=" w-72 bg-white rounded-3xl p-7 space-y-2">
