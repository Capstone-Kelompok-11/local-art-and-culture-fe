...
function Sidebar() {
    ...
    return (
    <>
        <button onClick={openSidebar} type="button" className="inline-flex items-center p-2 mt-2 ml-5 text-sm text-white rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-600">
        ...
        <aside 
            ...
            <div className="h-screen px-3 py-4 overflow-y-auto bg-[#253E8D]">
                ...
                <div className='mx-2 mb-10'>
                    <a className='cursor-pointer flex items-center justify-center py-3 p-2 text-gray-900 rounded-full bg-[#768DD5]'>+ Add New Event</a>
                </div>
